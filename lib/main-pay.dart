...
void main() {
  WidgetsFlutterBinding.ensureInitialized(); // 初始化，与 Flutter Engine 进行通信
...
class _MyAppState extends State<_MyApp> {
  final InAppPurchase _inAppPurchase = InAppPurchase.instance; // app 购买实例
  ...
  bool _purchasePending = false; // 等待购买
  bool _loading = true; // 加载中
  String? _queryProductError; // 产品错误信息
